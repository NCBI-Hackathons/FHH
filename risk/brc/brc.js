/* add breast cancer snomed

// Key Codes
/*
	"SNOMED_CT-363406005": "breast Cancer",
	...
	"SNOMED_CT-68496003": "breast Polyp",
...
function test_past_cancer() {
	...
	for (i=0;i<h.length;i++) {
		if (h[i]['Disease Code'] == 'SNOMED_CT-363406005') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk1") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-1000001') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk2") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-254582000') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk3") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-371973000') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk4") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-363418001') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk5") + "<br />";
				risk=true;
		}
		if (h[i]['SNOMED_CT-363443007'] == 'Ovarian Cancer') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk6") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-363349007') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk7") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-1000000') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk8") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-126952004') { 
			// This code comes from the old system
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk9") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-93870000') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk10") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-363518003') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk11") + "<br />";
				risk=true;
		}
		if (h[i]['Disease Code'] == 'SNOMED_CT-315058005') {
				risk_reason += $.t("fhh_breast_calculator.past_cancer_risk12") + "<br />";
				risk=true;
		}
	}
	if (risk) {
		...
		set_reason($("#past_cancers"), $.t("fhh_breast_calculator.past_cancer_negative"));
	}
...
function test_male_family_members_cancer() {
	var risk = false;
	risk_reason = "";
				...
				if (h.gender == 'MALE')	{
					for(i = 0; i < h.length; i++){
						if(h[i]['Disease Code'] == 'SNOMED_CT-254837009'){
							...
							risk_reason += name + " " + $.t("fhh_breast_calculator.family_members_cancer_risk1") + "<br />";
							risk=true;
						}
					}
				}
	...
	if (risk) {
		set_icon($("#male_family_members_breast_cancer"), 'positive');
		set_reason($("#male_family_members__breast_cancer"), risk_reason);
	} else {
		set_icon($("#male_family_members__breast_cancer"), 'negative');
		set_reason($("#male_family_members__breast_cancer"),$.t("fhh_breast_calculator.male_family_members__breast_cancer_negative"));		
		}
}
...
function test_immediate_family_members_cancer() {
  ...
  $.each(personal_information, function (key, item) {
				...
				if(temp == 'fath' || temp == 'moth' || temp == 'brot' || temp == 'sist' || temp == 'daug' || temp == 'son_') {
		  		if (check_blood_relative(key) == false) return true; // Skip adopted relatives
					...
					if (h[i]['Disease Code'] == 'SNOMED_CT-363406005') {
						...
						if (h[i]['Disease Code'] == 'SNOMED_CT-1000001') {
							name = get_name_or_relationship(this.name, key);
							risk_reason += name + " " + $.t("fhh_breast_calculator.family_members_cancer_risk2") + "<br />";
							risk=true;
						}
						if (h[i]['Disease Code'] == 'SNOMED_CT-254582000') {
							name = get_name_or_relationship(this.name, key);
							risk_reason += name + " " + $.t("fhh_breast_calculator.family_members_cancer_risk3") + "<br />";
							risk=true;
						}
						if (h[i]['Disease Code'] == 'SNOMED_CT-363349007') {
							name = get_name_or_relationship(this.name, key);
							risk_reason += name + " " + $.t("fhh_breast_calculator.family_members_cancer_risk4") + "<br />";
							risk=true;
						}
					}
				}
	...
	if (risk) {
		...
		set_reason($("#immediate_family_members_cancer"),$.t("fhh_breast_calculator.family_members_cancer_negative"));		
		}
...
function test_secondary_family_members_cancer() {
  ...
  $.each(personal_information, function (key, item) {
				...
				if(temp13 == 'maternal_uncl' || temp13 == 'paternal_uncl' || 
  				...
  				if (check_blood_relative(key) == false) return true; // Skip adopted relatives
					for (i=0;i<h.length;i++) {
						if (h[i]['Disease Code'] == 'SNOMED_CT-363406005') {
							name = get_name_or_relationship(this.name, key);
							risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_cancer_risk1") + "<br />";
							count++;
							break;  // We do not need to check this person anyore
						}
						if (h[i]['Disease Code'] == 'SNOMED_CT-1000001') {
							name = get_name_or_relationship(this.name, key);
							risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_cancer_risk2") + "<br />";
							count++;
							break;  // We do not need to check this person anyore
						}
						if (h[i]['Disease Code'] == 'SNOMED_CT-254582000') {
							name = get_name_or_relationship(this.name, key);
							risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_cancer_risk3") + "<br />";
							count++;
							break;  // We do not need to check this person anyore
						}
					}
	...
	if (count == 0) {
		risk = false;
		risk_reason = $.t("fhh_breast_calculator.secondary_family_members_cancer_risk4");		
	} else if (count == 1) {
		risk = false;
		risk_reason = $.t("fhh_breast_calculator.secondary_family_members_cancer_risk5") +  "<br />" + risk_reason;
		
	} else {
		risk = true;
		risk_reason = $.t("fhh_breast_calculator.secondary_family_members_cancer_risk6") +  "<br />" + risk_reason;
	} 
	...
	final_risk |= risk;
	// Goto Next test
	set_icon($("#secondary_family_members_breast_cancer_before_50"), 'calculating');
	setTimeout(test_secondary_family_members_breast_cancer_before_50, 500);
}

function test_secondary_family_members_breast_cancer_before_50() {
	var risk = false;
	risk_reason = "";
  $.each(personal_information, function (key, item) {
  	...
  	if (item != null) {
			...
			if (h != null) {
				...
				if(temp13 == 'maternal_uncl' || temp13 == 'paternal_uncl' || 
	  			...
	  			if (check_blood_relative(key) == false) return true; // Skip adopted relatives
					for (i=0;i<h.length;i++) {
						if (h[i]['Disease Code'] == 'SNOMED_CT-363406005' && is_age_before('Under50', h[i]['Age At Diagnosis']) ) {
							name = get_name_or_relationship(this.name, key);
							if (h[i]['Age At Diagnosis'] == 'Unknown') risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_breast_cancer_before_60_risk1") + "<br />";
							else risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_breast_cancer_before_50_risk2") + "<br />";
							risk=true;
						}
						if (h[i]['Disease Code'] == 'SNOMED_CT-1000001' && is_age_before('Under50', h[i]['Age At Diagnosis']) ) {
							name = get_name_or_relationship(this.name, key);
							if (h[i]['Age At Diagnosis'] == 'Unknown') risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_breast_cancer_before_60_risk3") + "<br />";
							else risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_breast_cancer_before_50_risk4") + "<br />";
							risk=true;
						}
						if (h[i]['Disease Code'] == 'SNOMED_CT-254582000' && is_age_before('Under50', h[i]['Age At Diagnosis']) ) {
							name = get_name_or_relationship(this.name, key);
							if (h[i]['Age At Diagnosis'] == 'Unknown') risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_breast_cancer_before_60_risk5") + "<br />";
							else risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_breast_cancer_before_50_risk6") + "<br />";
							risk=true;
						}
					}
				}
	...
	if (risk) {
		set_icon($("#secondary_family_members_breast_cancer_before_50"), 'positive');
		set_reason($("#secondary_family_members_breast_cancer_before_50"), risk_reason);
	} else {
		set_icon($("#secondary_family_members_breast_cancer_before_50"), 'negative');
		set_reason($("#secondary_family_members_breast_cancer_before_50"),$.t("fhh_breast_calculator.secondary_family_members_breast_cancer_before_50_negative"));
	}
...
function test_secondary_family_members_uterine_cancer_before_50() {
  ...
  $.each(personal_information, function (key, item) {
			  	...
			  	if (check_blood_relative(key) == false) return true; // Skip adopted relatives
					for (i=0;i<h.length;i++) {
						if (h[i]['Disease Code'] == 'SNOMED_CT-371973000' && is_age_before('Under50', h[i]['Age At Diagnosis']) ) {
							name = get_name_or_relationship(this.name, key);
							if (h[i]['Age At Diagnosis'] == 'Unknown') risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_uterine_cancer_before_50_risk1") + "<br />";
							else risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_uterine_cancer_before_50_risk2") + "<br />";
							risk=true;
						}
					}
				}
	...
	if (risk) {
		...
		set_reason($("#secondary_family_members_uterine_cancer_before_50"),$.t("fhh_breast_calculator.secondary_family_members_uterine_cancer_before_50_negative"));
	}
...
function test_secondary_family_members_uterine_cancer() {
  ...
  $.each(personal_information, function (key, item) {
				...
				if(temp13 == 'maternal_uncl' || temp13 == 'paternal_uncl' || 
			  	...
			  	if (check_blood_relative(key) == false) return true; // Skip adopted relatives
					for (i=0;i<h.length;i++) {
						if (h[i]['Disease Code'] == 'SNOMED_CT-371973000') {
							name = get_name_or_relationship(this.name, key);
							risk_reason += name + " " + $.t("fhh_breast_calculator.secondary_family_members_uterine_cancer_risk1") + "<br />";
							count++;
						}
					}
				}
	...
	if (count == 0) {
		risk = false;
		risk_reason = $.t("fhh_breast_calculator.secondary_family_members_uterine_cancer_risk2");
		
	} else if (count == 1) {
		risk = false;
		risk_reason = $.t("fhh_breast_calculator.secondary_family_members_uterine_cancer_risk3") + "<br />" + risk_reason;
		
	} else {
		risk = true;
		risk_reason = $.t("fhh_breast_calculator.secondary_family_members_uterine_cancer_risk4") + "<br />" + risk_reason;
	} 
...
function test_final() {
	if (final_risk) {
		...
		set_reason($("#final"),$.t("fhh_breast_calculator.final_risk1"));
...
function set_icon(field, state) {
	switch (state) {
		case 'waiting':
			$(field).find("#test").empty().append("<IMG alt='waiting' src='../risk/brc/blue_waiting.png' height='40'/>");
			break;
		case 'calculating':
			$(field).find("#test").empty().append("<IMG alt='calculating' src='../risk/brc/blue_calculating.gif' height='40'/>");
			break;
		case 'negative':
			$(field).find("#test").empty().append("<IMG alt='good_because_negative' src='../risk/brc/green_x.png' height='40'/>");
			break;
		case 'positive':
			$(field).find("#test").empty().append("<IMG alt='bad_because_positive' src='../risk/brc/red_check.png' height='40'/>");
			break;
